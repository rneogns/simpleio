...
bool ConfigManager::ReadConfig(char* fullpath)
{
	...
	// Mysql DB 설정을 읽는다
	mysqlConfig[ACCOUNT_DB].ip = serverConf.Get<string>("MYSQL.account_db_ip", "13.124.245.242");
	...
	mysqlConfig[ACCOUNT_DB].passwd = serverConf.Get<string>("MYSQL.account_db_passwd", "rneogns!1");
	mysqlConfig[ACCOUNT_DB].dbname = serverConf.Get<string>("MYSQL.account_db_name", "account");

	mysqlConfig[GAME_DB].ip = serverConf.Get<string>("MYSQL.game_db_ip", "13.124.245.242");
	...
	mysqlConfig[GAME_DB].passwd = serverConf.Get<string>("MYSQL.game_db_passwd", "rneogns!1");
	mysqlConfig[GAME_DB].dbname = serverConf.Get<string>("MYSQL.game_db_name", "account");

	// Redis 설정을 읽는다
	redisConfig[MASTER_REDIS].ip = serverConf.Get<string>("master_redis_ip", "13.124.245.242");
